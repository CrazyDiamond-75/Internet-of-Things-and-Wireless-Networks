...
/* Method for the SOURCE node, sends the current state of the button to connected nodes. */
static void send_message_SOURCE();

/* Method for the TARGET nodes, redirects some message to all connected nodes except the one it was received from. */
