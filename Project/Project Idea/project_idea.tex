...
The idea we had for our IoT project is a BLE-based user device position detection.
...
\begin{enumerate}
    \item We place three devices in an arbitrary formation (optimally in a circle) around a user device with Bluetooth on\footnote{This is not restricted to smartphones, but also smartwatches, which often permanently have Bluetooth on.}.
