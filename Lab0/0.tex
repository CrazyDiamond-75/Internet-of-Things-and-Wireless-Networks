...
\begin{exercise}[Basic Networking] \hfill
    \begin{itemize}
        ...
        \item[Q7] The advertiser tries to continuously broadcast \lstinline|"Hello IoT course!"|, while the scanner tries to receive the advertisement and print it with some meta information about it.
        \item[Q8]
    \end{itemize}
\end{exercise}
